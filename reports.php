...
// get select value of project id and pass it into filter variable and add it to array 
            ...
            <form action="reports.php" method="get" class="form-container form-report">
                <label for="filter">Filter:</label>
                    <select name="filter" id="filter">
                        ...
                        <?php 
                        //loop through project list and add them to select
